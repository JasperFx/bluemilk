...
namespace BlueMilk.Testing.IoC.Acceptance
{
    public class dependency_inlining
    {
        ...
        {
            theAssembly = new GeneratedAssembly(new GenerationRules("BlueMilk.Generated"));
        ...
        public void try_single_handler_no_args()
        {
            ...
            theCode.ShouldContain("var noArgMethod = new BlueMilk.Testing.IoC.Acceptance.NoArgMethod();");
        }
        ...
        public void try_single_handler_one_singleton_arg()
        {
            ...
            theCode.ShouldContain("var singletonArgMethod = new BlueMilk.Testing.IoC.Acceptance.SingletonArgMethod(_messageTracker);");
        }
        ...
        public void try_single_handler_two_singleton_arg()
        {
            ...
            theCode.ShouldContain("var multipleArgMethod = new BlueMilk.Testing.IoC.Acceptance.MultipleArgMethod(_messageTracker, _widget);");
        }
        ...
        public void try_single_handler_two_container_scoped_args()
        {
            ...
            theCode.ShouldContain("var widget = new BlueMilk.Testing.IoC.Acceptance.Widget();");
            theCode.ShouldContain("var messageTracker = new BlueMilk.Testing.IoC.Acceptance.MessageTracker();");
            theCode.ShouldContain("var multipleArgMethod = new BlueMilk.Testing.IoC.Acceptance.MultipleArgMethod(messageTracker, widget);");
        }
        ...
        public void try_single_handler_two_container_scoped_args_one_disposable()
        {
            ...
            theCode.ShouldContain("using (var disposedWidget = new BlueMilk.Testing.IoC.Acceptance.DisposedWidget())");
            theCode.ShouldContain("var messageTracker = new BlueMilk.Testing.IoC.Acceptance.MessageTracker();");
            theCode.ShouldContain("var multipleArgMethod = new BlueMilk.Testing.IoC.Acceptance.MultipleArgMethod(messageTracker, disposedWidget);");
        }
        ...
        public void try_single_handler_two_container_scoped_args_both_disposable()
        {
            ...
            theCode.ShouldContain("using (var disposedMessageTracker = new BlueMilk.Testing.IoC.Acceptance.DisposedMessageTracker())");
            theCode.ShouldContain("using (var disposedWidget = new BlueMilk.Testing.IoC.Acceptance.DisposedWidget())");
            theCode.ShouldContain("var multipleArgMethod = new BlueMilk.Testing.IoC.Acceptance.MultipleArgMethod(disposedMessageTracker, disposedWidget);");
        }
        ...
        public void try_single_handler_one_transient_arg()
        {
            ...
            theCode.ShouldContain("var messageTracker = new BlueMilk.Testing.IoC.Acceptance.MessageTracker();");
            theCode.ShouldContain("var singletonArgMethod = new BlueMilk.Testing.IoC.Acceptance.SingletonArgMethod(messageTracker);");
        }
        ...
        public void try_single_handler_one_transient_arg_that_is_disposable()
        {
            ...
            theCode.ShouldContain("using (var disposedMessageTracker = new BlueMilk.Testing.IoC.Acceptance.DisposedMessageTracker())");
            theCode.ShouldContain("var singletonArgMethod = new BlueMilk.Testing.IoC.Acceptance.SingletonArgMethod(disposedMessageTracker);");
        }
        ...
        public void multiple_actions_using_the_same_transient()
        {
            ...
            theCode.ShouldContain("var widget1 = new BlueMilk.Testing.IoC.Acceptance.Widget();");
            theCode.ShouldContain("var multipleArgMethod = new BlueMilk.Testing.IoC.Acceptance.MultipleArgMethod(_messageTracker, widget2);");
            theCode.ShouldContain("var widget2 = new BlueMilk.Testing.IoC.Acceptance.Widget();");
            theCode.ShouldContain("var widgetUser = new BlueMilk.Testing.IoC.Acceptance.WidgetUser(widget1);");
        }
        ...
        public void multiple_actions_using_the_same_scoped()
        {
            ...
            theCode.ShouldContain("var widget = new BlueMilk.Testing.IoC.Acceptance.Widget();");
            theCode.ShouldContain("var multipleArgMethod = new BlueMilk.Testing.IoC.Acceptance.MultipleArgMethod(_messageTracker, widget);");
            theCode.ShouldContain("var widgetUser = new BlueMilk.Testing.IoC.Acceptance.WidgetUser(widget);");
        }
        ...
        public void multiple_actions_using_the_same_disposable_transient()
        {
            ...
            theCode.ShouldContain("using (var disposedWidget1 = new BlueMilk.Testing.IoC.Acceptance.DisposedWidget())");
            theCode.ShouldContain("using (var disposedWidget2 = new BlueMilk.Testing.IoC.Acceptance.DisposedWidget())");
        }
        ...
        public void multiple_actions_one_cannot_be_reduced()
        {
            ...
            theCode.ShouldContain("var widgetUser = (BlueMilk.Testing.IoC.Acceptance.WidgetUser)serviceProvider.GetService(typeof(BlueMilk.Testing.IoC.Acceptance.WidgetUser));");
            theCode.ShouldContain("var singletonArgMethod = (BlueMilk.Testing.IoC.Acceptance.SingletonArgMethod)serviceProvider.GetService(typeof(BlueMilk.Testing.IoC.Acceptance.SingletonArgMethod));");
        }
...
/*
        ...
        public void use_a_known_variable_in_the_mix()
        {
            ...
            code.ShouldContain("var usesKnownServiceThing = new BlueMilk.Testing.IoC.Acceptance.UsesKnownServiceThing(session);");
        }
        ...
        */
        ...
        public void can_reduce_with_closed_generic_service_dependency()
        {
            ...
            theCode.ShouldContain("var genericServiceUsingMethod = new BlueMilk.Testing.IoC.Acceptance.GenericServiceUsingMethod<string>();");

            theCode.ShouldContain("new BlueMilk.Testing.IoC.Acceptance.Service<string>(_messageTracker);");
        ...
        public void can_reduce_with_array_dependency()
        {
            ...
            theCode.ShouldContain("var handlerWithArray = new BlueMilk.Testing.IoC.Acceptance.HandlerWithArray(widgetArray);");
        }
        ...
        public void use_registered_array_if_one_is_known()
        {
            ...
            theCode.ShouldContain("var handlerWithArray = new BlueMilk.Testing.IoC.Acceptance.HandlerWithArray(_widgetArray);");
        }
        ...
        public void use_registered_enumerable_if_one_is_known()
        {
            ...
            theCode.ShouldContain("var widgetEnumerableUser = new BlueMilk.Testing.IoC.Acceptance.WidgetEnumerableUser(_widgetIEnumerable);");
        }
        ...
        public void use_registered_list_if_one_is_known()
        {
            ...
            theCode.ShouldContain("var widgetListUser = new BlueMilk.Testing.IoC.Acceptance.WidgetListUser(_widgetList);");
        }
        ...
        public void use_registered_Ilist_if_one_is_known()
        {
            ...
            theCode.ShouldContain("var widgetIListUser = new BlueMilk.Testing.IoC.Acceptance.WidgetIListUser(_widgetIList);");
        }
