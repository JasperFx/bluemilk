...
using System.Linq;
using BlueMilk.Testing.IoC.Compliance.Fakes;
using Microsoft.Extensions.DependencyInjection;
using Xunit;

namespace BlueMilk.Testing.IoC.Compliance
{
    public class DependencyInjectionSpecificationTests
    {
        ...
        public class TestServiceCollection : ServiceRegistry
        {
        }
        ...
        public static TheoryData ServiceContainerPicksConstructorWithLongestMatchesData
        {
            get
            {
                ...
                return new TheoryData<IServiceCollection, TypeWithSupersetConstructors>
                {
                    ...
                    {
                        new TestServiceCollection().AddSingleton<IFactoryService>(factoryService),
        ...
        public void ResolvesMixedOpenClosedGenericsAsEnumerable()
        {
            ...
            // BlueMilk is NOT making this assumption about ordering
