...
namespace BlueMilk.Testing.IoC
{
    public class using_family_policies
    {
        ...
        public void default_policies_in_empty_graph()
        {
            ...
            graph.FamilyPolicies[0].ShouldBeOfType<CloseGenericFamilyPolicy>();
            graph.FamilyPolicies[1].ShouldBeOfType<ConcreteFamilyPolicy>();
            graph.FamilyPolicies[2].ShouldBeOfType<EmptyFamilyPolicy>();
