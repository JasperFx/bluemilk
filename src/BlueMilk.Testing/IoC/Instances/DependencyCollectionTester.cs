...
namespace StructureMap.Testing.Pipeline
{
    public class DependencyCollectionTester
    {
        ...
        public void if_an_enumerable_type_and_there_is_no_exact_match_by_type_try_ienumerable_of_the_element_type()
        {
            ...
            collection.FindByTypeOrName(typeof(IList<IGateway>), null).ShouldBeSameAs(instance);
            collection.FindByTypeOrName(typeof(List<IGateway>), null).ShouldBeSameAs(instance);
            collection.FindByTypeOrName(typeof(IGateway[]), null).ShouldBeSameAs(instance);
        }
        */
