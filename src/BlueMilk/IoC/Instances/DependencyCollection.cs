...
namespace BlueMilk.IoC.Instances
{
    ...
    public class DependencyCollection : IEnumerable<Argument>
    {
        ...
        private Argument findByTypeOnly(Type argumentType)
        {
            ...
            if (argument == null && EnumerablePolicy.IsEnumerable(argumentType))
            {
                var elementType = EnumerablePolicy.DetermineElementType(argumentType);
        ...
        public void Add(string name, Type type, object @dependency)
        {
            if (type != null && type.IsSimple())
            {
                ...
                {
                    if (@dependency.As<LambdaInstance>().ImplementationType != type)
                    {
                        throw new BlueMilkException(
        ...
        public object Get(string name)
        {
            ...
            return value is ObjectInstance
                ? value.As<ObjectInstance>().Service
                : value;
        }
